  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.alLinksContainer}>
          <Link title={'Contact Admin'} navigation={navigation} />
          <Link title={'Send Feedback'} navigation={navigation} />
          <Link title={'FAQs'} navigation={navigation} />
        </View>
