      ...
      >
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.infoText}>
            Ride from {ride.pickupLocation.substring(0, ride.pickupLocation.indexOf(","))} to {ride.dropoffLocation.substring(0, ride.dropoffLocation.indexOf(","))} on {month} {day}, {year} at {hours}:{min < 10 && 0}{min}{amOrPm} has been requested.
          </Text>
          <Text></Text>
          <Text style={styles.infoText}>
